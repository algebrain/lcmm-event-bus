...
- `CausationPath`: Множество типов событий, породивших данное сообщение.
...
## 2. Использование `CorrelationID`, `CausationPath` и `MessageType`
...
- **Детекция циклов:** Если тип нового события уже присутствует в `CausationPath`, шина бросает исключение (Fail-fast).
