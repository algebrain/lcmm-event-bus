...
## 8. Долговременная доставка (Durability)

- При включенном долговременном режиме шина должна сохранять сообщения и доставлять их **как минимум один раз**.
- Повторная доставка возможна, обработчики обязаны быть идемпотентными.
- Атомарность между бизнес-БД и публикацией не является обязанностью шины.
