...
For a deeper dive into the architectural principles, see [ARCH.en.md](docs/ARCH.en.md).
...
For detailed API documentation, function signatures, and usage examples, please see **[BUS.en.md](docs/BUS.en.md)**.
