...
For a deeper dive into the architectural principles, see [ARCH.md](ARCH.md).
...
For detailed API documentation, function signatures, and usage examples, please see **[BUS.en.md](BUS.en.md)**.
