...
`docs/` and `docs_en/` contain architecture notes, API docs, and behavior requirements.  
...
Tests use `clojure.test` and run through Kaocha.  
...
- Doc updates in `README.md`, `docs/`, or `docs_en/` when behavior or API changes.
